...
scan_btn = Button(wrapper3, text="Scanner", command=scan_finger)

info_label = Label(wrapper3, text="info")
...
info_label.grid(row=5, column=3, padx=5, pady=3)
scan_btn.grid(row=5, column=1, padx=5, pady=3)
